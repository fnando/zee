...
module ListenerTest
  ...
  class UsingListenersTest < Minitest::Test
    ...
    test "sets string representation for listener" do
      listener = Zee::Listener::Listener.new(self, :on, :ready, &-> { })

      assert_equal "<Zee::Listener::Listener event: on_ready>", listener.to_s
    end
  end
