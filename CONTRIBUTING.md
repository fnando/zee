...
mailing lists is expected to follow the [code of conduct](https://github.com/fnando/zee/blob/main/CODE_OF_CONDUCT.md).
...
by [opening an issue on Github](https://github.com/fnando/zee/issues).

When you're ready to make your pull request, follow checklist below to make sure
your contribution is according to how this project works.

1. [Fork](https://help.github.com/forking/) zee
